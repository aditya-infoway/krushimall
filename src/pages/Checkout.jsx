...
// 
  ...
  const stateOptions = State.getStatesOfCountry(shippingInfo.country).map(
    (s) => ({
      value: s.isoCode,
      label: s.name,
    }),
    ...
    try {
      ...
      const data = await apiHelper.post("/web/orders/place", {
        ...
        address: shippingInfo.address,
         country: countryOptions.find((o) => o.value === shippingInfo.country)?.label || "",
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8  md:pt-16 pt-12 lg:pt-20">
      <div className="w-full xl:max-w-400 2xl:max-w-430 mx-auto px-4 sm:px-6 lg:px-20 xl:px-24 2xl:px-46">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-4 mb-6 sm:mb-8 overflow-x-auto pb-2">
          ...
          <div className="w-10 sm:w-16 h-0.5 bg-gray-200 shrink-0"></div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        value={
                          countryOptions.find(
                            (o) => o.value === shippingInfo.country,
                          ) || null
                        }
                        onChange={(selected) =>
                          setShippingInfo({
            ...
            <div className="bg-white rounded-2xl border border-gray-300 p-4 sm:p-6 lg:sticky lg:top-24">
              ...
              <div className="space-y-3 mb-4 max-h-60 overflow-y-auto">
                {cart.map((item) => (
                  <div
                    key={item.cartItemId}
                    className="flex gap-3 text-sm min-w-0"
                  >
                    <img
                      src={apiHelper.getImageUrl(item.image)}
                      alt={item.name}
                      className="w-12 h-12 sm:w-14 sm:h-14 object-contain bg-gray-100 rounded-lg shrink-0"
                    />
